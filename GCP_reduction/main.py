...
output_file = '/Users/prishajain/Desktop/MTP/GCP_reduction/output.txt'
...
model_path = '/Users/prishajain/Desktop/MTP/GCP_reduction/model_parameters/gcn_model.pth'
    ...
    with open(output_file, 'w', buffering=1) as file:
        for graph_name, graph in graphs.items():
            ...
            while l <= r:
                ...
                new_adj_list = convert_to_adj_list(reduced_graph)
