...
def predict_mis(model, graph, time_budget=300, num_maps=16, max_solutions=8):
    """
    Implements tree search algorithm to find multiple maximum independent sets using
    ...
    Returns:
        list: List of MIS solutions (each a dict of node labels) with the best size
    """
    ...
    return list(best_solutions.values())[:max_solutions]